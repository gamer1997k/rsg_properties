-- Assuming RSGCore and RSGCore.Functions are already defined somewhere before this script
if not RSGCore then RSGCore = {} end
if not RSGCore.Functions then RSGCore.Functions = {} end

-- Define the GetPlayer function
local function GetPlayer(source)
    -- Placeholder logic to get a player
    -- This should be replaced with actual logic to retrieve the player information
    local player = RSGCore.Players[source]
    return player
end

RSGCore.Functions.GetPlayer = GetPlayer
