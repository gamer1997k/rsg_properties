...
Citizen.CreateThread(function()
    for menu, v in pairs(Config.Houses) do
        exports['rsg-core ']:createPrompt(v.number..'-stash', v.menu, 0xF3830D8E, 'Open Stash', { -- ["J"]
            type = 'client',
            event = 'rsg_properties:client:housestash',
            args = {v.number},
        })
		exports['rsg-core ']:createPrompt(v.number..'-clothing', v.menu, 0xC7B5340A, 'Open Outfits', { -- ["ENTER"]
            type = 'client',
            event = 'rsg-clothing:client:openMenu',
...
RegisterNetEvent('rsg_properties:client:housestash', function(house)
	local PlayerHouse = exports['rsg-core ']:GetPlayerData().metadata["house"]
	if PlayerHouse == house then
		...
		exports['rsg-core ']:Notify(9, 'you don\'t have access to this stash', 5000, 0, 'mp_lobby_textures', 'cross', 'COLOR_WHITE')
	end
end)
